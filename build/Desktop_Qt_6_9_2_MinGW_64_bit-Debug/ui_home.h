...
public:
    ...
    void setupUi(QWidget *Home)
    {
        ...
        B2_SelPro->setGeometry(QRect(250, 10, 30, 30));
        L2_energy = new QLabel(Home);
        L2_energy->setObjectName("L2_energy");
        L2_energy->setGeometry(QRect(45, 360, 100, 40));
        QFont font;
        ...
        L2_joules->setGeometry(QRect(145, 375, 60, 20));
        L2_joules->setStyleSheet(QString::fromUtf8("font-size: 12pt;"));
        B2_ready_for_surgery = new QPushButton(Home);
        B2_ready_for_surgery->setObjectName("B2_ready_for_surgery");
        B2_ready_for_surgery->setGeometry(QRect(590, 400, 191, 50));
        QFont font1;
...
"font-size: 14pt;"));
        ...
        L2_energy_show->setGeometry(QRect(45, 400, 191, 60));
        QFont font2;
        font2.setFamilies({QString::fromUtf8("Roboto")});
        font2.setPointSize(52);
        L2_energy_show->setFont(font2);
        L2_energy_show->setStyleSheet(QString::fromUtf8("color: rgb(94, 255, 80);\n"
"font-size: 52pt;"));
        L2_energy_show->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        T2_home = new QTabWidget(Home);
        T2_home->setObjectName("T2_home");
        T2_home->setGeometry(QRect(20, 50, 761, 307));
...
"font: 22pt \"Roboto\";"));
        ...
        L2_watts->setGeometry(QRect(110, 20, 55, 20));
        L2_watts->setStyleSheet(QString::fromUtf8("font-size: 12pt;"));
        ...
        B2_980sub->setGeometry(QRect(190, 100, 50, 50));
        B2_980add = new home_button(homeframe_2);
        B2_980add->setObjectName("B2_980add");
        B2_980add->setGeometry(QRect(270, 100, 50, 50));
...
"font-size: 52pt;"));
        ...
        L2_seconds->setGeometry(QRect(105, 20, 70, 20));
        L2_seconds->setStyleSheet(QString::fromUtf8("font-size: 12pt;"));
        B2_timer_add = new home_button(homeframe_3);
        B2_timer_add->setObjectName("B2_timer_add");
        B2_timer_add->setGeometry(QRect(270, 125, 50, 50));
        B2_timer_sub = new home_button(homeframe_3);
        B2_timer_sub->setObjectName("B2_timer_sub");
        B2_timer_sub->setGeometry(QRect(190, 125, 50, 50));
        B2_timer_sub->setStyleSheet(QString::fromUtf8(""));
        ...
        L2_timer_show->setGeometry(QRect(50, 120, 121, 60));
        L2_timer_show->setFont(font2);
        L2_timer_show->setStyleSheet(QString::fromUtf8("color: rgb(50, 155, 255);\n"
"font-size: 52pt;"));
        L2_timer_show->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
...
"font-size: 14pt;"));
        ...
        B2_on_time_sub->setGeometry(QRect(190, 100, 50, 50));
        B2_on_time_add = new home_button(homeframe_5);
        B2_on_time_add->setObjectName("B2_on_time_add");
        B2_on_time_add->setGeometry(QRect(270, 100, 50, 50));
...
"font-size: 52pt;"));
        ...
        B2_alarm_sec_add->setGeometry(QRect(270, 100, 50, 50));
        B2_alarm_sec_sub = new home_button(homeframe_6);
        B2_alarm_sec_sub->setObjectName("B2_alarm_sec_sub");
        B2_alarm_sec_sub->setGeometry(QRect(190, 100, 50, 50));
        B2_alarm_sec_sub->setStyleSheet(QString::fromUtf8(""));
        ...
        B2_joule_alarm->setAutoExclusive(true);
...
"font-size: 52pt;"));
        ...
        L2_avg_watts->setGeometry(QRect(190, 375, 60, 20));
        L2_avg_watts->setStyleSheet(QString::fromUtf8("font-size: 12pt;"));
        L2_avg_power_show = new QLabel(Home);
        L2_avg_power_show->setObjectName("L2_avg_power_show");
        L2_avg_power_show->setGeometry(QRect(45, 400, 171, 60));
        L2_avg_power_show->setFont(font2);
        L2_avg_power_show->setStyleSheet(QString::fromUtf8("color: rgb(94, 255, 80);\n"
"font-size: 52pt;"));
        L2_avg_power_show->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        pushButton = new QPushButton(Home);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(310, 420, 80, 24));

        retranslateUi(Home);

        T2_home->setCurrentIndex(1);
    ...
    void retranslateUi(QWidget *Home)
    {
        ...
        L2_joules->setText(QCoreApplication::translate("Home", "(Joules)", nullptr));
        B2_ready_for_surgery->setText(QCoreApplication::translate("Home", "Ready for Surgery", nullptr));
        L2_energy_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        L2_power->setText(QCoreApplication::translate("Home", "Power", nullptr));
        L2_watts->setText(QCoreApplication::translate("Home", "(Watts)", nullptr));
        ...
        B2_980sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        B2_980add->setText(QCoreApplication::translate("Home", "+", nullptr));
        B2_1470sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        B2_1470add->setText(QCoreApplication::translate("Home", "+", nullptr));
        L2_980_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        L2_1470_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        L2_timer->setText(QCoreApplication::translate("Home", "Timer", nullptr));
        L2_seconds->setText(QCoreApplication::translate("Home", "(Seconds)", nullptr));
        B2_timer_add->setText(QCoreApplication::translate("Home", "+", nullptr));
        B2_timer_sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        B2_timer_on->setText(QString());
        B2_timer_off->setText(QCoreApplication::translate("Home", "Off", nullptr));
        L2_timer_show->setText(QCoreApplication::translate("Home", "0", nullptr));
        ...
        label_2->setText(QCoreApplication::translate("Home", "ON time (ms)", nullptr));
        label->setText(QCoreApplication::translate("Home", "OFF time (ms)", nullptr));
        B2_on_time_sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        B2_on_time_add->setText(QCoreApplication::translate("Home", "+", nullptr));
        B2_off_time_sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        B2_off_time_add->setText(QCoreApplication::translate("Home", "+", nullptr));
        L2_on_pulse_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        L2_off_pulse_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        B2_pulsemode->setText(QCoreApplication::translate("Home", "Pulse Mode", nullptr));
        B2_alarm_sec_add->setText(QCoreApplication::translate("Home", "+", nullptr));
        B2_alarm_sec_sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        ...
        B2_alarm_joule_add->setText(QCoreApplication::translate("Home", "+", nullptr));
        B2_alarm_joule_sub->setText(QCoreApplication::translate("Home", "-", nullptr));
        ...
        L2_avg_watts->setText(QCoreApplication::translate("Home", "(Watts)", nullptr));
        L2_avg_power_show->setText(QCoreApplication::translate("Home", "0.0", nullptr));
        pushButton->setText(QCoreApplication::translate("Home", "Forms", nullptr));
    } // retranslateUi
