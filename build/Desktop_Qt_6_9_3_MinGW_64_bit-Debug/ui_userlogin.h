...
public:
    ...
    void setupUi(QWidget *Userlogin)
    {
        ...
        tital_2 = new QLabel(Userlogin);
        tital_2->setObjectName("tital_2");
        tital_2->setGeometry(QRect(230, 45, 340, 31));
        tital_2->setStyleSheet(QString::fromUtf8("font-size: 16pt;"));
        tital_2->setAlignment(Qt::AlignmentFlag::AlignCenter);
    ...
    void retranslateUi(QWidget *Userlogin)
    {
        ...
        back_to_setting->setText(QCoreApplication::translate("Userlogin", "\360\237\241\220", nullptr));
        tital_2->setText(QString());
    } // retranslateUi
