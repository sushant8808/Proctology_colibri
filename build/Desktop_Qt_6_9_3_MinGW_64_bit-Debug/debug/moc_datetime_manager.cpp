/****************************************************************************
** Meta object code from reading C++ file 'datetime_manager.h'
**
...
#error "The header file 'datetime_manager.h' doesn't include <QObject>."
...
void DateTimeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DateTimeManager::*)(const QDateTime & )>(_a, &DateTimeManager::dateTimeChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void DateTimeManager::dateTimeChanged(const QDateTime & _t1)
{
